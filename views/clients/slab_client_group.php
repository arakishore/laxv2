...
.jp-multiselect select {max-height: 230px;}
.jp-multiselect {display:block;}
.jp-multiselect select {width:100%;}
.jp-multiselect .from-panel {float:left; width:45%;}
.jp-multiselect .from-panel option {width:100%; display:block;}
.jp-multiselect .move-panel {float:left; width:10%;}
.jp-multiselect .to-panel {float:left; width:45%;;}
...
<body>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="col-md-4">
                                        <a href="javascript:;" class="ls-modal btn btn-xs btn-warning pull-right"
                                            onclick="showAddGroupClientForm('', 'Add');">
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($allClientsInfo as $key => $clientDetails){ 
                                                ...
                                                $getClientsSlabInfo =  str_replace(","," , ",$clientDetails['content_owner']);
                                            ?>
                                            <tr>
                                                <td><?php echo $clientDetails["group_name"]; ?></td>

                                                <td><?php echo $getClientsSlabInfo; ?></td>


                                                <td>
                                                    <a href="javascript:void(0);"
                                                        class="ls-modal btn btn-xs btn-success"
                                                        onclick="showAddGroupClientForm('<?php echo htmlentities(trim($clientDetails['group_name'])); ?>', '<?php echo $clientDetails['group_name']?>');">
                                                        <span class="fa fa-edit"></span>
                                                    </a> | <a  href="javascript:void(0);" class="btn btn-xs btn-danger" onclick="confirmDeleteClient('<?php echo trim($clientDetails['group_name']);?>','<?php echo htmlentities(trim($clientDetails['group_name']));?>');"> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="deleteClientBtn" data-user-name=""
    ...
    function deleteClient(buttonElement) {
        let group_name = $(buttonElement).data("user-name");
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo $rootUrl; ?>controller/client/delete/deleteslabgroup.php",
            data: {
    ...
    function showAddGroupClientForm(group_name, actionType) {
       
        $("#addClientModal .modal-title span").html(actionType);
        $("#addClientModal .modal-body-content").load(
            "<?php echo $rootUrl; ?>views/clients/manage/managegroup.php?group_name=" + encodeURIComponent(group_name)
        );
