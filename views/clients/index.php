                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php $clientDataDetails=json_decode($clientDetails["client_type_details"]); 
                                                          ...
                                                          $revenueAmazon = (isset($clientDataDetails->revenueAmazon)) ? $clientDataDetails->revenueAmazon : 0;

                                                          $revenueGaana = (isset($clientDataDetails->revenueGaana)) ? $clientDataDetails->revenueGaana : 0;

                                                          $revenueSaavan = (isset($clientDataDetails->revenueSaavan)) ? $clientDataDetails->revenueSaavan : 0;
                                                          

                                                          $revenueSpotify = (isset($clientDataDetails->revenueSpotify)) ? $clientDataDetails->revenueSpotify : 0;
                                                          ...
                                                          ."Revenue Saavan Music : "."<b>$revenueGaana % </b>"."<br>"
                                                          ."Revenue Gaana Music : "."<b>$revenueSaavan % </b>"."<br>"
                                                          ."Revenue Spotify Music : "."<b>$revenueSpotify % </b>"."<br>"
                                                          ."Revenue Amazon : "."<b>$revenueAmazon % </b>");                                                     
                                                ?>
                                            </br>===================</br>
                                            <?php 
                    $client_youtube_shares_Details = (isset($clientDetails["client_youtube_shares"]) && $clientDetails["client_youtube_shares"]!='') ?  json_decode($clientDetails["client_youtube_shares"],true) :array(); 
 
                                        
                                    
                                        foreach($client_youtube_shares_Details as $key2 => $valeHolding) {
                                           // $key1 = str_replace(' ', '_', $key2);
                                            echo "<br>Youtube-Holding - ( {$key2} ) : <b>".$valeHolding." %</b>";
                                        }
                                                ...
                                                ?>
                                                    <td> 
                                                        <a href="javascript:void(0);" 
                                                            class="ls-modal btn btn-xs btn-success" onclick="showAddClientForm('<?php echo htmlentities(trim($clientDetails['client_username'])); ?>', 'Edit');"
                                                        >
                                                            <span class="fa fa-edit"></span>
                                                        </a></br>
                                                        <a  href="javascript:void(0);" class="btn btn-xs btn-danger" onclick="confirmDeleteClient('<?php echo trim($clientDetails['client_username']);?>','<?php echo htmlentities(trim($clientDetails['client_firstname']));?>');"> 
                                                       ...
                                                       <?php
                                                              ...
                                                              ?>
                                                       <a  href="javascript:void(0);"  id="clientDashboard" class="btn-xs btn ls-modal btn-success" onclick="showClientDashboard('<?php echo trim($clientDetails['email']); ?>');" >
                                                           <span class="fa fa-dashboard"></span>
                                                       </a></br>
                                                       <?php
                                                       }
