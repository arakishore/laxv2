...
<div class="row">
    ...
    <input type="hidden" class="form-control" data-parsley-trigger="keyup"  id="group_name"
                    name="group_name" value="<?php echo $group_name; ?>">
                    <input type="hidden" class="form-control" data-parsley-trigger="keyup"  id="group_id"
...
$('form#addEditClientForm').parsley().on('field:validated', function() {
    ...
    .on('form:submit', function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo $rootUrl; ?>controller/client/manageslabviagroup.php",
            data: formData,
            data: formData,
            contentType: false,
            cache: false,
