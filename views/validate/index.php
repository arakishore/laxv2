                                    ...
                                    <form class="form-inline" enctype="multipart/form-data" id="uploadReportForm"
                                        ...
                                        <div class="col-md-12  nd1 nd2 ndkids redmusic hidealldefault">
                                            ...
                                            <div class="col-md-4 " id="youtubend">
                                                <div class="form-group">
                                                    ...
                                                    <input type="month" placeholder="Select Date"
                                                        class="form-control nd" id="selected_datev2_1"
                                            ...
                                            <div class="col-md-4" id="redmuscidiv">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report Youtube Youtube Music
                                                        v2.0:</p>

                                                    <i class="fa fa-calendar" style="color: #3688ca;"></i>
                                                    <input type="month" placeholder="Select Date"
                                                        class="form-control nd" id="selected_datev2_4"
                                                        name="selected_date" autocomplete="off" size="28">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report youtube Red Finance v2.0:
                                                    </p>

                                                    <i class="fa fa-calendar" style="color: #3688ca;"></i>
                                                    <input type="month" placeholder="Select Date"
                                                        class="form-control nd" id="selected_datev2_2"
                                                        name="selected_date" autocomplete="off" size="28">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report youtube ecommerce paid
                                                        features v2.0:</p>

                                                    <i class="fa fa-calendar" style="color: #3688ca;"></i>
                                                    <input type="month" placeholder="Select Date"
                                                        class="form-control nd" id="selected_datev2_3"
                                                        name="selected_date" autocomplete="off" size="28">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <i class="fa fa-calendar" style="color: #3688ca;"></i>
                                                    <input type="month" placeholder="Select Date"
                                                        class="form-control nd" id="selected_datev2_5"
                                                        name="selected_date" autocomplete="off" size="28">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate YouTube WithHolding Percentage Report:</p>

                                                    <i class="fa fa-calendar" style="color: #3688ca;"></i>
                                                    <input type="month" placeholder="Select Date"
                                                        class="form-control nd" id="selected_datev2_6"
                                                        name="selected_date" autocomplete="off" size="28">


                                                    <div class="col-md-6 ndbtnYoutubenddiv"
                                                        id="uploadReportFilesContainerv2_6" style="display: none">
                                                        <a href="../validate/youTube_withholding_percentage_report_v2.php"
                                                            class="btn btn-success ndbtnYoutubend">Go</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4   applemusic hidealldefault">
                                            ...
                                            <div class="col-md-4 " id="applemusic">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report Apple Music v2.0:</p>
                                                    ...
                                                    <div class="col-md-6 ndbtnYoutubenddiv"
                                                        ...
                                                        style="display: none">
                                                        <a href="../validate/applemusicv2.php"
                                                            class="btn btn-success ndbtnYoutubend">Go</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4   itune hidealldefault">
                                            ...
                                            <div class="col-md-4 " id="itune">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report itune Music v2.0:</p>
                                        ...
                                        <div class="col-md-4   gaana hidealldefault">
                                            ...
                                            <div class="col-md-4 " id="gaana">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report Gaana Music v2.0:</p>
                                        ...
                                        <div class="col-md-4   saavan hidealldefault">
                                            ...
                                            <div class="col-md-4 " id="saavan">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report saavan Music v2.0:</p>
                                        ...
                                        <div class="col-md-4   spotify hidealldefault">
                                            ...
                                            <div class="col-md-4 " id="spotify">
                                                <div class="form-group">
                                                    <p style="font-size:16px;">Validate Report spotify Music v2.0:</p>
...
?>
    ...
    $('#selected_datev2_6').change(function() {
        var selectedDate = $('#selected_datev2_6').val();

        var nd = $("#nd").val();
        var k = $('#uploadReportFilesContainerv2_6 a').attr('href');
        $('#uploadReportFilesContainerv2_6 a').attr('href', k.split("?")[0] + '?reportMonthYear=' +
            selectedDate + '&nd=' + nd);
        $("#uploadReportFilesContainerv2_6").show();
    });
