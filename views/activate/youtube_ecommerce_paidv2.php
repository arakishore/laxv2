...
<body>
    ...
    <div class="header" id="youtube1">
        <div class="row">
            ...
            <div class="col-lg-3">
                <h4 class="modal2-title">Activate Reports YouTube Ecommerce paid features  - <?php echo $nd?> -  <?php echo $_GET["reportMonthYear"];?> </h4>
            </div>
        </div>
    </div>
    ...
    <div id="alert" class="alert alert-default" style="display: none;">
        ...
        <div class="card">
         ...
         $fileis=  'youtube_ecom_paid_features_activation_report_'.$nd.'_'.$year.'_'.$month.'.zip';
    ...
    $('#btnExportunAssigned').on('click', function(e) {
        $.ajax({
            ...
            data: {
                ...
                type: 'youtube_ecommerce_paid_features_activation_report',
                nd: '<?php echo $nd?>'
            },
    ...
    function saveContentowner(ids, status) {
        ...
        $.ajax({
            ...
            data: {
                ...
                report: 'youtube_ecommerce_paid_features_activation_report'
            },
            success: function(response) {
