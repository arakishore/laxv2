<?php
   ...
   if (!noError($conn)) {
       ...
       $nd_label = ($nd=="redmusic") ? 'Youtube Music':$nd;
       $selectedDate = $_GET["reportMonthYear"];
       $year     = date("Y", strtotime($selectedDate));
       $month    = date("m", strtotime($selectedDate));
  
       $haveactivationreport = false;
       $activatetableName = 'youtube_whp_activation_report_'.$nd.'_'.$year.'_'.$month; ;
...
<body>
    ...
    <div class="header" id="youtube1">
        <div class="row">
            ...
            <div class="col-lg-11">
                ...
                <h4 class="modal2-title">Activate Report withHolding Percentage  <?php echo $nd_label?> -<?php echo $selectedDate?></h4>
            </div>
        </div>
    </div>
    ...
    <div id="alert" class="alert alert-default" style="display: none;">
        ...
        <div class="card">
         ...
         $fileis=  'youtube_whp_activation_report_'.$nd.'_'.$year.'_'.$month.'.zip';
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $clientDetails["AdSense_Earnings_Month"]; ?></td>
                            <td><?php echo $clientDetails["Channel_ID"]; ?></td>
                            <td><?php echo $clientDetails["Revenue_Source"]; ?></td>
                            <td><?php echo $clientDetails["Local_Currency"]; ?></td>
                            <td><?php echo $clientDetails["Total_Channel_Revenue"]; ?></td>
                            <td><?php echo $clientDetails["US_Sourced_Revenue"]; ?>%</td>
                            <td><?php echo $clientDetails["Tax_Withholding_Rate"]; ?></td>
                            <td><?php echo $clientDetails["Tax_Withheld_Amount"]; ?></td>
    ...
    $('#btnExportunAssigned').on('click', function(e) {
        $.ajax({
            ...
            data: {
                ...
                type: 'youtube_whp_activation_report',
                nd: '<?php echo $nd?>'
            },
    ...
    function saveContentowner(ids, status) {
        ...
        $.ajax({
            ...
            data: {
                ...
                report: 'youtube_whp_activation_report'
            },
            success: function(response) {
