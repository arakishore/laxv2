...
<body>
    ...
    <div class="header" id="youtube1">
        <div class="row">
            ...
            <div class="col-lg-5">
                <h4 class="modal2-title">Activate Report Spotify Music <?php echo $nd?> -  <?php echo $_GET["reportMonthYear"];?> </h4>
            </div>
        </div>
    </div>
    ...
    <div id="alert" class="alert alert-default" style="display: none;">
        ...
        <div class="card">
         ...
         $fileis=  'report_audio_activation_'.$nd.'_'.$year.'_'.$month.'.zip';
                //report_audio_activation_spotify_2021_09.zip
    ...
    $('#genrateReport').on('click', function(e) {
        $.ajax({
            ...
            data: {
                selected_date: '<?php echo $_GET["reportMonthYear"];?>',
                nd: '<?php echo $_GET["nd"];?>',
                type: 'report_audio_activation_spotify'
            },
            success: function(response) {
                //alert(response);
