       ...
       if (!noError($userInfo)) {
           ...
           if (empty($userInfo)) {
               ...
               if ($userInfo[$email]["status"]!=1) {
                   ...
                   $allClientsCount = getActivationReportv2($activatetableName,$clientSearchArr, $fieldsStr, null, $conn);
                ...
                <table class="table table-bordered table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th>Amt Payable</th>
                            <th>US Payout</th>
                            <th>US Payout(YouTube)</th>
                            <th>Holding Perc(avg)</th>
                            <th>Witholding</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $US_Sourced_Revenue; ?></td>
    ...
    $('#genrateReport').on('click', function(e) {
        $.ajax({
            ...
            data: {
                selected_date: '<?php echo $_GET["reportMonthYear"];?>',
                nd: '<?php echo $_GET["nd"];?>',
                type: 'youtubeclaimreport_activation_report'
            },
            success: function(response) {
                //alert(response);
