...
<body>
    ...
    <div class="header" id="youtube1">
        <div class="row">
            ...
            <div class="col-lg-11">
                <h4 class="modal2-title">Activate Report Youtube  Music  - <?php echo $nd?> -  <?php echo $_GET["reportMonthYear"];?></h4>
            </div>
        </div>
    </div>
    ...
    <div id="alert" class="alert alert-default" style="display: none;">
        ...
        <div class="card">
         ...
         $fileis=  'youtube_redmusic_activation_report_'.$nd.'_'.$year.'_'.$month.'.zip';
    ...
    $('#btnExportunAssigned').on('click', function(e) {
        $.ajax({
            ...
            data: {
                ...
                type: 'youtuberedmusic_video_report',
                nd: '<?php echo $nd?>'
            },
    ...
    $('#genrateReport').on('click', function(e) {
        $.ajax({
            ...
            data: {
                selected_date: '<?php echo $_GET["reportMonthYear"];?>',
                nd: '<?php echo $_GET["nd"];?>',
                type: 'youtubeRedmusic_activation_report'
            },
            success: function(response) {
                //alert(response);
    ...
    function saveContentowner(ids, status) {
        ...
        $.ajax({
            ...
            data: {
                ...
                report: 'youtubeRedmusic_activation_report'
            },
            success: function(response) {
