...
if (!noError($conn)) {
    ...
    //print_r($clientInfo);
     if (!noError($clientInfo)) {
        ...
        $activatetableName  = 'youtube_ecom_paid_features_activation_report_'.$type_table.'%_'.$year.'_'.$month;
    ...
    $finance_report_table = 'youtube_red_music_finance_activation_report_nd1'.$year.'_'.$month;
...
<body>
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">youtube ecommerce paid features v2 <?php echo htmlspecialchars($_GET['reportMonthYear']); ?></h4>
    ...
    <div class="col-md-4">
        ...
        $fileis = $_SESSION['client'] . '_youtube_ecommerce_paid_features_' . $year . '_' . $month . '.zip';
...
?>
    ...
    <div class="col-md-4">
        ...
        $fileis = $_SESSION['client'] . '_youtube_ecommerce_paid_features_' . $year . '_' . $month . 'withholding.zip';
        if (file_exists('../../../excelreports/' . $fileis)) {
            ?>
        <a href='../../../excelreports/<?=$fileis?>'><button type="button" name="btnDownload" id="btnDownload"
    ...
    <div class="col-md-2">
        <a href="youtubeecommercepaidfeaturesv2_detailview_v2.php?userName=<?php echo $userName?>&type_table=<?php echo $type_table?>&reportMonthYear=<?php echo $_GET["reportMonthYear"]?>"
  ...
  $allClientsInfo0  = ExportClientsYoutubeecompaidfeaturereportv2($table_type_name, $conn,$offset,$resultsPerPage,$searchdata,$clientsession,$downlaodType);
    ...
    */
    $('#export_withholding').on('click', function(e) {
        ...
        $.ajax({
            ...
            data: {
                selected_date: '<?php echo $_GET["reportMonthYear"];?>',
                type: 'youtubeecommercepaidfeaturesv2',
