...
//redsubscription_non_cmg
    $type_table = (isset($_GET['type_table'])) ? $_GET['type_table'] :'main_non_cmg';
    ...
    //end check current month data
     ...
     $table_name1 = 'report_publishing_'.$type_table.'_' . $year . '_' . $month;
...
?>
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <h4 class="modal2-title">Publisher Non CMG (Main) :  <?php echo $selectedDate?> </h4>
    ...
    <div class="col-md-4">
        ...
        $fileis = $_SESSION['client'] . '_report_publishing_'.$type_table.'_' . $year . '_' . $month . '.zip';
...
?>
    ...
    <div class="col-md-2">
        <!-- <a href="spotifymusic_detailview_v2.php?type_table=<?php echo $type_table?>&userName=<?php echo $userName?>&reportMonthYear=<?php echo $_GET["reportMonthYear"]?>"
...
$allClientsInfo = getActivationReportSummaryNONCMGv2(
    $table_type_name,
    $clientSearchArr,
    $_SESSION['client'],
    $conn
...
<div class="col-md-12">
            <div class="alert alert-default">
                ...
                <h5>Total partnerRevenue Received : <?php echo $activationdata['total_amt_recd']?> USD </h5>
