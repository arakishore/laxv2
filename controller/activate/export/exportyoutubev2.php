    ...
    if (!noError($allClientsInfocount)) {
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         if ($export) {
            ...
            $xcelfiles = [];
            $headtitle = ['Content Owner','Amount Recd','shares','Amount Payable', 'US Payout', 'US Payout-Youtube','Holding-Perc', 'Holding-Amt', 'Holding-Amt-Youtube', 'Final Payable','GST-Perc','Final Payable-GST','Status'];
