...
if (!noError($conn)) {
    ...
    //validate filepath
/* $argv[0] = "";
$argv[1] = "youtube_video_claim_report_nd1_2021_01";
$argv[2] = "youtube_video_claim_activation_report_nd1_2021_01";
 */
    ...
    $loged_email_id = (isset($argv[3])) ? $argv[3] :'';
    ...
    $paramlog['table_name'] = $actableName;
    $paramlog['file_name'] = '';
    $paramlog['status_name'] = "Activation";
    ...
    $insertInfoArr = generateActicationwithholdingPercentageReportv4($tableName,$actableName,$conn);
