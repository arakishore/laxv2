...
if (!noError($conn)) {
    ...
    $allClientsInfocount  = ExportwithholdingUnAssignedv5($youtube_report_table, $conn,$offset,$resultsPerPage,'',$youtube_report_table);
    ...
    if (!noError($allClientsInfocount)) {
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         $emailMessage = $importSuccessEmailMessage."<p>Successfully Exported Youtube withholding  in ".$importtime;
        ...
        //send error email
        $emailMessage = $importFailureEmailMessage."<p>Could not Exported Youtube withholding data</p>". json_encode($logData);
