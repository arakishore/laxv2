...
$importFailureEmailMessage = "<div>
    <p>There was an error importing the youTube_withholding_percentage_report_file_upload into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error importing the youTube_withholding_percentage_report_file_upload into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
 $date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $logMsg = "youTube_withholding_percentage_report_file_upload background process start: ".date("Y-m-d h:i:s");
 ...
 */
    ...
    $emailSubject = "Import youTube_withholding_percentage_report_file_upload Report";
    ...
    $insertInfoArr = insert_youtube_whp_reportv4($filePath, $tableName, $conn);
    ...
    if (!noError($insertInfoArr)) {
        ...
        $autoAssignChannelCOMap = autoAssign_ContentOwner_youtube_whp_v4(
            $tableName,
            $conn
        );
